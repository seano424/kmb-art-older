...
export default function SidebarLayout({ children }) {
  ...
  return (
    <>
      <div
        className={`transition-opacity duration-500 ease-in-out fixed z-20 bg-white shadow-md lg:pl-12 flex min-h-screen top-28 lg:pr-12 lg:mt-0 lg:top-0 md:overflow-x-hidden flex-col lg:w-72 flex-shrink-0 ${
          open
